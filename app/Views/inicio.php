...
<body>
    ...
    <div class="container mt-4">
            <h2>Tickets Activos o Finalizados</h2>

                <!-- Sección de Usuario Logueado y Botones para Filtrar Tickets -->
            <div class="row mb-4">
                <div class="col-md-6 d-flex">
                    <!-- Botón para ver tickets activos -->
                    <a href="<?= base_url('inicio-taller'); ?>" class="btn btn-custom-active mr-2">
                        Ver Tickets Activos
                    </a>
                    <!-- Botón para ver tickets finalizados -->
                    <a href="<?= base_url('inicio-Inactivos'); ?>" class="btn btn-custom-inactive mr-2">
                        Ver Tickets Finalizados
                    </a>
                    <!-- Botón para crear nuevo ticket -->
                    <a href="<?= base_url('crear-ticket'); ?>" class="btn btn-custom-new">
                        Crear Nuevo Ticket
                    </a>
                </div>
            </div>
            ...
            <div class="search-form">
                <form id="formBuscar" method="post" action="<?= base_url('verTicket'); ?>"> 
                    <div class="input-group" style="max-width: 350px; float: right;">
                        <input type="number" class="form-control" placeholder="Ingrese numero de Ticket" id="buscar" name="buscar" required>
                        ...
                        <?php foreach ($tickets as $ticket): ?>
                            <tr>
                                ...
                                <td class="action-buttons">
                                    <a href="<?= base_url('obtenerTicket/' . $ticket['Id_Ticket']); ?>" class='btn btn-primary btn-sm'>Editar</a>
                                    <!-- Botón Ver Detalles -->
